...
#
# Script generated by Vivado on Fri May 08 20:47:17 PDT 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_event_buffer.sh
...
#
# Usage        : fifo_event_buffer.sh
#                fifo_event_buffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_event_buffer.sh [-rerun]
#                fifo_event_buffer.sh [-reset_run]
#                fifo_event_buffer.sh [-clean]
#                fifo_event_buffer.sh [-reset_log]
#                fifo_event_buffer.sh [-help]
#
...
#                script (type 'fifo_event_buffer.sh -help' for more information).
#
...
# script info
echo -e "fifo_event_buffer.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_event_buffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_14 $vlogan_opts +v2k +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_event_buffer xil_defaultlib.glbl -o fifo_event_buffer_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_event_buffer_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tirth/Classes/Midterms_ECE3300/FaultAnalyzer/FaultAnalyzer.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fifo_event_buffer_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_event_buffer_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_event_buffer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_event_buffer.sh [-help]\n\
Usage: fifo_event_buffer.sh [-step]\n\
Usage: fifo_event_buffer.sh [-lib_map_path]\n\
Usage: fifo_event_buffer.sh [-rerun]\n\
Usage: fifo_event_buffer.sh [-reset_run]\n\
Usage: fifo_event_buffer.sh [-clean]\n\
Usage: fifo_event_buffer.sh [-reset_log]\n\
Usage: fifo_event_buffer.sh [-keep_index]\n\
Usage: fifo_event_buffer.sh [-noclean_files]\n\n\
