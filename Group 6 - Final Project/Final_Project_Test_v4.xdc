...
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L24P_T3_35 Sch=sw[12]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { reset_clk }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
...
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { light }]; #IO_L22N_T3_A04_D20_14 Sch=led[13]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { lights }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
...
##Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { btn_pause }]; #IO_L9P_T1_DQS_14 Sch=btnc
